(() => {
  const Z = window.TransitPublic = window.TransitPublic || {};
  ...
  Z.isCompletedSegment = (segmentIndex, originalCurrent, moving, reverse = false) => reverse
    ? (moving ? segmentIndex > originalCurrent : segmentIndex >= originalCurrent)
    : (moving ? segmentIndex < originalCurrent - 1 : segmentIndex < originalCurrent);
